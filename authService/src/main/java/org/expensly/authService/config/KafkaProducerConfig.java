...
import org.expensly.authService.utils.serializer.UserInfoSerializer;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, UserInfoMessageKafka> producerFactory() {
        Map<String, Object> configs = commonProducerConfigs();
        configs.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configs.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, UserInfoSerializer.class);
        return new DefaultKafkaProducerFactory<>(configs);
    }

    @Bean
    public KafkaTemplate<String, UserInfoMessageKafka> kafkaTemplate() {
